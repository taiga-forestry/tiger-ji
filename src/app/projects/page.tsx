    ...
    <div className="grid grid-rows-[auto_1fr_auto] min-h-[100vh]">
      ...
      <main className="px-48 lg:px-[120px] py-24">
        ...
        <section className="grid lg:grid-cols-2 py-24 md:p-36 gap-24 justify-center">
          <MainProject title="Currents Event Replay" description="Automating historical data recovery processes for Braze customers" src="replay" tools={["Kotlin", "PostgreSQL", "Apache Kafka"]} links={{ demo: "FIXME" }} />
        ...
        <section className="grid md:grid-cols-2 py-24 sm:p-24 justify-center">
          <OtherProject title="Figma Grapes Exporter" description="Streamlining marketing campaigns via Figma-to-Braze Integrations" tools={["TypeScript", "Figma Plugin API"]} links={{ demo: "FIXME" }} />
          ...
          <OtherProject title="Word Hunt Solver" description="Solving my favorite word game of all time like a true computer scientist" tools={["Python, Flask"]} links={{ github: "https://github.com/taiga-forestry/Word-Hunt-Solver", demo: "https://whsolver.pythonanywhere.com/" }} />
